...
- 最初のプログラムを `docs/en/programs/engineering_agents/` と `docs/ja/programs/engineering_agents/` に追加: ConOps、システムグラフ（凡例＋グラフ）、要求、境界、検証／妥当性確認、マトリクス、競合トレードオフ、`model/*.yaml`（en を正）。
