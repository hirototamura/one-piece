...
This file is the **control tower** for AI agents working on one-piece: a systems-engineering SaaS for **teams of any size**—requirements, design, verification, and traceability for hardware. **Domain authority** between humans and agents is adjustable: when humans hold 100% authority, agents draft, cross-check, and keep artifacts consistent; when agents hold 100% authority, they run the full workflow without human intervention to iterate hypotheses at high speed.
